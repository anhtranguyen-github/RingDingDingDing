...
class BasicComponent:
    """
    Base Class for Readers, Chunkers, Embedders, Retrievers, and Generators.
    """
...
class Embedding(BasicComponent):
    """
    Interface for Embedder Components.
    """
...
class Retriever(BasicComponent):
    """
